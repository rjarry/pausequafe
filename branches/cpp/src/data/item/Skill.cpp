...
Attribute Skill::getPrimaryAttribute() {
    return primaryAttribute;
}
Attribute Skill::getSecondaryAttribute() {
    return secondaryAttribute;
}
// setters //
void Skill::setRank(uint rank) {
    this->rank = rank;
}
void Skill::setPrimaryAttribute(Attribute attribute) {
    this->primaryAttribute = attribute;
}
void Skill::setSecondaryAttribute(Attribute attribute) {
