...
#ifndef ITEMTREESORTFILTERPROXYMODEL_H
#define ITEMTREESORTFILTERPROXYMODEL_H

#include <QSortFilterProxyModel>

class ItemTreeSortFilterProxyModel : public QSortFilterProxyModel
{
public:
    ItemTreeSortFilterProxyModel();
};

#endif // ITEMTREESORTFILTERPROXYMODEL_H
