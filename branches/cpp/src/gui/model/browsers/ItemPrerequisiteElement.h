...
#ifndef ITEMPREREQUISITEELEMENT_H
#define ITEMPREREQUISITEELEMENT_H

#include "GroupElement.h"

class ItemPrerequisiteElement : public GroupElement
{
public:
    ItemPrerequisiteElement();
};

#endif // ITEMPREREQUISITEELEMENT_H
