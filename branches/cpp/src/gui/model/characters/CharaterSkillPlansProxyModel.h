...
#ifndef CHARATERSKILLPLANSPROXYMODEL_H
#define CHARATERSKILLPLANSPROXYMODEL_H

#include <QAbstractProxyModel>

class CharaterSkillPlansProxyModel : public QAbstractProxyModel
{
public:
    CharaterSkillPlansProxyModel();
};

#endif // CHARATERSKILLPLANSPROXYMODEL_H
