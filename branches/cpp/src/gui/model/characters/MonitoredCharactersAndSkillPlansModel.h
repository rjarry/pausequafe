...
#ifndef MONITOREDCHARACTERSANDSKILLPLANSMODEL_H
#define MONITOREDCHARACTERSANDSKILLPLANSMODEL_H

#include <QAbstractItemModel>

class MonitoredCharactersAndSkillPlansModel : public QAbstractItemModel
{
public:
    MonitoredCharactersAndSkillPlansModel();
};

#endif // MONITOREDCHARACTERSANDSKILLPLANSMODEL_H
