...
#ifndef BROWSERSKILLTAB_H
#define BROWSERSKILLTAB_H

#include <QWidget>

namespace Ui {
    class BrowserSkillTab;
}

class BrowserSkillTab : public QWidget {
    Q_OBJECT
public:
    BrowserSkillTab(QWidget *parent = 0);
    ~BrowserSkillTab();
...
private:
    Ui::BrowserSkillTab *ui;
};

#endif // BROWSERSKILLTAB_H
