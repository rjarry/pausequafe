...
#ifndef BROWSERSHIPTAB_H
#define BROWSERSHIPTAB_H

#include <QWidget>

namespace Ui {
    class BrowserShipTab;
}

class BrowserShipTab : public QWidget {
    Q_OBJECT
public:
    BrowserShipTab(QWidget *parent = 0);
    ~BrowserShipTab();
...
private:
    Ui::BrowserShipTab *ui;
};

#endif // BROWSERSHIPTAB_H
