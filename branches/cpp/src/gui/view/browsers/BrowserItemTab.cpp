...
#include "BrowserItemTab.h"
#include "ui_BrowserItemTab.h"

BrowserItemTab::BrowserItemTab(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::BrowserItemTab)
{
    ui->setupUi(this);
}

BrowserItemTab::~BrowserItemTab()
{
    delete ui;
}

void BrowserItemTab::changeEvent(QEvent *e)
{
