...
#ifndef ABSTRACTBROWSERTAB_H
#define ABSTRACTBROWSERTAB_H

#include <QWidget>

class AbstractBrowserTab : public QWidget {
    Q_OBJECT
public:
    AbstractBrowserTab(QWidget *parent = 0);
    ~AbstractBrowserTab();


};

#endif // ABSTRACTBROWSERTAB_H
