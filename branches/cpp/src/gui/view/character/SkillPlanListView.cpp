...
#include "SkillPlanListView.h"
#include "ui_SkillPlanListView.h"

SkillPlanListView::SkillPlanListView(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::SkillPlanListView)
{
    ui->setupUi(this);
}

SkillPlanListView::~SkillPlanListView()
{
    delete ui;
}

void SkillPlanListView::changeEvent(QEvent *e)
{
