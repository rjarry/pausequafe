...
#include "ErrorAPICorrupted.h"
#include "ui_ErrorAPICorrupted.h"

ErrorAPICorrupted::ErrorAPICorrupted(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ErrorAPICorrupted)
{
    ui->setupUi(this);
}

ErrorAPICorrupted::~ErrorAPICorrupted()
{
    delete ui;
}

void ErrorAPICorrupted::changeEvent(QEvent *e)
{
