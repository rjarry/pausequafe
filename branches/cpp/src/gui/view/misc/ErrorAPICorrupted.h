...
#ifndef ERRORAPICORRUPTED_H
#define ERRORAPICORRUPTED_H

#include <QDialog>

namespace Ui {
    class ErrorAPICorrupted;
}

class ErrorAPICorrupted : public QDialog {
    Q_OBJECT
public:
    ErrorAPICorrupted(QWidget *parent = 0);
    ~ErrorAPICorrupted();
...
private:
    Ui::ErrorAPICorrupted *ui;
};

#endif // ERRORAPICORRUPTED_H
