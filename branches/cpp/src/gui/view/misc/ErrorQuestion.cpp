...
#include "ErrorQuestion.h"
#include "ui_ErrorQuestion.h"

ErrorQuestion::ErrorQuestion(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ErrorQuestion)
{
    ui->setupUi(this);
}
...
void ErrorQuestion::changeEvent(QEvent *e)
{
