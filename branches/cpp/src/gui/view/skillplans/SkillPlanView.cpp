...
#include "SkillPlanView.h"
#include "ui_SkillPlanView.h"

SkillPlanView::SkillPlanView(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::SkillPlanView)
{
    ui->setupUi(this);
}

SkillPlanView::~SkillPlanView()
{
    delete ui;
}

void SkillPlanView::changeEvent(QEvent *e)
{
