...
#include "AddSkillPlanDialog.h"
#include "ui_AddSkillPlanDialog.h"

AddSkillPlanDialog::AddSkillPlanDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddSkillPlanDialog)
{
    ui->setupUi(this);
}

AddSkillPlanDialog::~AddSkillPlanDialog()
{
    delete ui;
}

void AddSkillPlanDialog::changeEvent(QEvent *e)
{
