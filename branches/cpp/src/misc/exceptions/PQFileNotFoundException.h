...
#ifndef PQFILENOTFOUNDEXCEPTION_H
#define PQFILENOTFOUNDEXCEPTION_H

#include "PQException.h"

class PQFileNotFoundException : public PQException
{
public:
    PQFileNotFoundException();
};

#endif // PQFILENOTFOUNDEXCEPTION_H
