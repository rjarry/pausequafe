...
#ifndef PQUSERDATABASEFILECORRUPTED_H
#define PQUSERDATABASEFILECORRUPTED_H

#include "PQException.h"

class PQUserDatabaseFileCorrupted : public PQException
{
public:
    PQUserDatabaseFileCorrupted();
};

#endif // PQUSERDATABASEFILECORRUPTED_H
