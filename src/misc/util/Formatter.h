...
{
public:
	static QString printDouble(double number);
	static QString printLong(long number);
	static QString printPercent(double number);
	static QString printTime(long time);
	static QString printTimeShort(long time);
	static QString printLevel(unsigned level);
	static QString printSkillInQueue(SkillInQueue & skill);
};
