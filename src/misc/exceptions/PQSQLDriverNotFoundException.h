...
#ifndef PQSQLDRIVERNOTFOUNDEXCEPTION_H
#define PQSQLDRIVERNOTFOUNDEXCEPTION_H

#include "PQException.h"

class PQSQLDriverNotFoundException : public PQException
{
public:
    PQSQLDriverNotFoundException();
};

#endif // PQSQLDRIVERNOTFOUNDEXCEPTION_H
