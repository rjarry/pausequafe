...
/**
 * Represents the API response for a character. <br>
 * <br>
 * It contains all the information regarding the character :
 * <ul>
 * <li>Name, Race, Corporation name, etc.
 * <li>Account balance
...
public class CharacterSheet {
    ...
    /**
     * Calculates the effective attribute value which will be used for skill training speed.<br>
     * <br>
