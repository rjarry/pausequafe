...
#include "BrowserSkillTab.h"
#include "ui_BrowserSkillTab.h"

BrowserSkillTab::BrowserSkillTab(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::BrowserSkillTab)
{
    ui->setupUi(this);
}

BrowserSkillTab::~BrowserSkillTab()
{
    delete ui;
}

void BrowserSkillTab::changeEvent(QEvent *e)
{
