...
#ifndef BROWSERSWINDOW_H
#define BROWSERSWINDOW_H
...
class BrowsersWindow : public QWidget {
    Q_OBJECT
public:
    BrowsersWindow(QWidget *parent = 0);
    ~BrowsersWindow();
...
private:
    Ui::BrowsersWindow *ui;
};

#endif // BROWSERSWINDOW_H
