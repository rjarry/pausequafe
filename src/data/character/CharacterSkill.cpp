...
// getters //
/////////////
uint CharacterSkill::getTypeID() {
    return typeID;
}

uint CharacterSkill::getSkillPoints() {
    return skillPoints;
}

uint CharacterSkill::getLevel() {
    return level;
}
...
// setters //
/////////////
void CharacterSkill::setTypeID(uint typeID) {
    this->typeID = typeID;
}

void CharacterSkill::setSkillPoints(uint skillPoints) {
    this->skillPoints = skillPoints;
}

void CharacterSkill::setLevel(uint level) {
    this->level = level;
}
