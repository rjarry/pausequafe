...
#ifndef MONITOREDCHARACTERDAO_H
#define MONITOREDCHARACTERDAO_H

#include "AbstractSqlDAO.h"

class MonitoredCharacterDAO : public AbstractSqlDAO
{
public:
    MonitoredCharacterDAO();
};

#endif // MONITOREDCHARACTERDAO_H
