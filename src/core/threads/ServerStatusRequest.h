...
#ifndef SERVERSTATUSREQUEST_H
#define SERVERSTATUSREQUEST_H

#include <QThread>

class ServerStatusRequest : public QThread
{
Q_OBJECT
public:
    explicit ServerStatusRequest();
