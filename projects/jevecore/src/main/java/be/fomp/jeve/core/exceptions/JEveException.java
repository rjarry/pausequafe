 ...
 *	<br />
 * 
 * The general Exception thrown by all JEve methods
 * 
 * @version 1.0
 * @author Sven Meys
 * 
...
public class JEveException extends Exception {

	public JEveException() {
	}

	public JEveException(String message) {
		super(message);
	}

	public JEveException(Throwable cause) {
		super(cause);
	}

	public JEveException(String message, Throwable cause) {
		super(message, cause);
	}
